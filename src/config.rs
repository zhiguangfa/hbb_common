...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "zhiguangfa".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.113.124.47"];
pub const RS_PUB_KEY: &str = "ZIqFVPdT1xnPv8WvReMOTmrZQbH+HXyTWtcP+WyuvMo=";
